...
| `XSEC-SPH-03` | `AUTHORIZED TASK DEFINITION` — [`XSEC-SPH-03-OWNER-APPROVAL.md`](tasks/XSEC-SPH-03-OWNER-APPROVAL.md) and [`XSEC-SPH-03-REQUEST.md`](tasks/XSEC-SPH-03-REQUEST.md) bind a source-interface proof only: official pinned-release support, original SPH state transitions, four unchanged assertions, two retained byte-identical captures, and independent high review. | Execute XSEC-SPH-03 only. A PASS makes XSEC-03-R2 eligible; a BLOCKED disposition preserves XSEC-03-R2 as ineligible. |
