...
Phase 7A activation has also completed `P7-T01` and `P7-T02`: the approved
point-kinetics and I/Xe transitions are implemented and T3-validated; stable
timestep policy, dynamic spatial coupling, scenarios, and G7A evidence remain
deferred.
