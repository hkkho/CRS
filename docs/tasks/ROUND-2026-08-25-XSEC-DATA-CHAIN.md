...
| `XSEC-RUNNER-01` | Reproduce the exact external DRAGON5 launch/procedure-loader context for the official hash-bound TCWUX11 fixture. | `XSEC-SPH-01` runner-probe blocker; preserve all source assertions and fixture identities; record path-free runner manifests and independent high review. No capture, mapping, result, or data admission. |
